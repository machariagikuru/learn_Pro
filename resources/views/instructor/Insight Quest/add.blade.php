...
@section('title', 'Add Insight Quest')
  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="page-header mb-4 p-3 bg-white shadow-sm rounded">
        <h1 class="mb-0 text-center" style="letter-spacing: 1.5px;">Add Insight Quest</h1>
      </div>
      <div class="div_deg">
        @if ($errors->any())
        ...
        @endif
        <form class="add" action="{{ route('insight_quest.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <!-- Course Selection -->
          <div>
          ...
          <div>
            ...
            <textarea name="description" id="description" placeholder="Enter quest description" required></textarea>
          </div>
          <!-- Image Upload -->
          <div>
